                       ...
                       unsigned char const *user_name)
{
  ...
  if (!client_flag) {
    ...
    if (header_str) {
      ...
      fprintf(f, "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">\n<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=%s\"/><title>%s</title><script src=\"ejudge/standings.js\"></script><link rel=\"stylesheet\" type=\"text/css\" href=\"ejudge/standings.css\"></head><body><h1>%s</h1>",
              charset,
              header, header);
    }
  } else {
